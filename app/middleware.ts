...
export const config = {
  matcher: [
     ...
     */
    '/((?!_next/static|_next/image|favicon.ico|logo-icon.png|manifest.json|logo.png|apple-icon.png|icon.png|apple-touch-icon.png|android-icon|favicon-|ms-icon-|browserconfig.xml).*)',
  ],
}
