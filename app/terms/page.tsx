        ...
        <div className="card space-y-6 text-sm">
          <section>
            ...
            <p className="text-gray-700">
              DMRT is a registered charity in Ireland. The Service is provided to support DMRT&apos;s charitable activities and is intended for use by authorised team members, PRO, and team leaders only.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 mb-3 space-y-1 ml-4">
              <li>Authorised DMRT team members (as defined by approved email addresses)</li>
              <li>DMRT PRO (Public Relations Officer)</li>
              <li>DMRT team leaders</li>
            </ul>
            <p className="text-gray-700">
              Access is granted through email-based authentication. You must use an email address that has been pre-approved by DMRT. Unauthorised access attempts are prohibited and may result in legal action.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700">
              <strong>Important:</strong> Your data submitted to Google Gemini AI is not used for training or fine-tuning AI models. This is guaranteed by our active Paid Billing Account and EEA location. See our <a href="/privacy" className="text-blue-600 hover:underline">Privacy Policy</a> for details.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 mb-3 space-y-1 ml-4">
              ...
              <li>Notifying DMRT immediately if you suspect unauthorised access</li>
