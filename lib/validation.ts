...
/**
 * Validates photo URLs to prevent SSRF attacks
 * Only allows URLs from trusted sources (Vercel Blob storage)
 */
export function validatePhotoUrl(url: string): boolean {
  ...
  try {
    ...
    // Block private IPs, localhost, and internal addresses
    ...
    // Only allow Vercel Blob storage domains
    // Vercel Blob URLs typically look like: https://*.public.blob.vercel-storage.com/...
